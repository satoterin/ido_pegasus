...
const initData = {
  ...
  heading: "Purcharse, Vip Account, and sell extraordinary NFTs",
  content: "Explore on the world's best & largest NFT marketplace",
  btn_1: "Buy Vip acocunt",
  btn_2: "Go Profile",
};
          ...
          <div className="row">
            <div className="col-12 col-md-6 col-lg-7">
              ...
              <div className="button-group">
                <Link to="/activity">
                  <div className="btn btn-bordered-white">
          ...
          >
            <defs>
              <linearGradient
                ...
                id="linearGradient-1"
              >
                <stop stopColor="rgba(69,40,220, 0.3)" offset="50%" />
