                        ...
                        <div className="col-12">
                            ...
                            <div className="intro d-flex justify-content-between align-items-end m-0">
                                <div className="intro-content">
                                    <span>{"Purcharsed Vip Accounts"}</span>
                                    <h3 className="mt-3 mb-0">{'Pegasus Vip Account'}</h3>
                                </div>
                                ...
                                <div key={`cd_${idx}`} className="col-12 col-sm-6 col-lg-3 item">
                                    <div className="card no-hover text-center">
                                        <div className="image-over">
                                            <a href="/item-details">
                                                <img className="card-img-top" src={"img/vip-1.gif"} alt="" />
                                            </a>
                                            {/* Seller */}
                                            <a className="seller" href="/item-details">
                                                <div className="seller-thumb avatar-lg">
                                                    <img className="rounded-circle" src={"img/vip-0.gif"} alt="" />
                                                </div>
                                            </a>
                                        </div>
                                        {/* Card Caption */}
